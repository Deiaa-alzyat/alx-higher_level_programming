#!/usr/bin/python3
"""9-rectangle defines a Rectangle class."""
...
class Rectangle:
    ...
    def width(self, value):
        ...
        Args:value: value of the width, must be a positive integer
        """
    ...
    def height(self, value):
        ...
        Args:value: value of the height, must be a positive integer
        """
        if not isinstance(value, int):
    ...
    def area(self):
        ...
        Returns:Area of the the rectangle, given by height * width
        """
        return self.__width * self.__height

    def perimeter(self):
        """Calculates the perimeter of a Rectangle instance
        Returns:Perimeter of the rectangle, given by 2 * (height + width)
        """
        if self.__height == 0 or self.__width == 0:
            return 0
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:rect_1: Rectangle instance
    ...
    def square(cls, size=0):
        ...
        Args:size: size to set the new rectangle to
